...
import com.techexe.androidroom.Common.HTTPStatusCodes;
import com.techexe.androidroom.Common.LoadingView;
import com.techexe.androidroom.Common.NetworkUtils;
...
//    private Context context=null;
     ...
     */
    public AppRequest() {
        this.preferences = MyApplication.getMyApp().getPreferences();
    }
    ...
    public JsonObjectRequest jsonObjectRequest(Context context, String Url, int method, final Map<String,String> params, final OnResponse onResponse) {
        try {
            if (context == null){
                Log.e("Error","Context can not be null");
            }
    ...
    public void jsonArrayRequest(final Context context, String Url, int method, JSONArray jsonArray, final OnResponse onResponse, String loadingMessage) {
        try {
            if (context == null){
                Log.e("Error","Context can not be null");
            }
            ...
            final LoadingView view = new LoadingView((AppCompatActivity)context);

            view.show(((AppCompatActivity)context).getSupportFragmentManager(),null);
    ...
    public void jsonArrayRequest(final Context context, String Url, int method, final Map<String,String> params, final OnResponse onResponse, String loadingMessage) {
        try {
            if (context == null){
                Log.e("Error","Context can not be null");
            }
    ...
    private <T> void addRequest(Request<T> req) {
        MyApplication.getMyApp().addToRequestQueue(req);
    }
